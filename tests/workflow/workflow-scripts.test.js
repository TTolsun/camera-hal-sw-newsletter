...
test('weekly newsroom workflow separates review PR success from publish-ready gate', () => {
  ...
  assert.match(workflow, /labels\.push\('needs-fix', 'editor-review', 'review-only-publication'\)/);
  assert.match(workflow, /labels\.push\('needs-fix', 'editor-review', 'diagnostics-only'\)/);
