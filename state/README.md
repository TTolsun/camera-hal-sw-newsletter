...
이 폴더는 파이프라인 운영 state를 둡니다. 읽기 전용 source registry(`src/core/data/`)나 서빙되는 site data(`articles/data/`)와 구분되며, JSON key와 enum-like 값은 machine contract이므로 번역하지 않습니다.
