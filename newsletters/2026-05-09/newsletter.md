...
CameraX 1.4.0-alpha07은 Camera HAL 변경 요구가 아니라 app/framework compatibility signal입니다. HAL 팀은 기존 validation matrix에서 회귀만 확인하고, HAL 조치는 downstream evidence가 있을 때만 분리합니다.
...
## 4. Native Tooling Watch

### Glaze 7.2: native tooling serialization 관찰
...
Glaze 7.2는 host-side native tooling 관찰 항목입니다. 편집장은 production code 변경 요구로 읽히지 않도록 범위를 유지해야 합니다.
