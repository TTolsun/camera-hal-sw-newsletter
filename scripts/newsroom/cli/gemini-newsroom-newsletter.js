...
function publicArticleContractPrompt() {
  return [
    ...
    'public_article.headline은 source title을 그대로 복사하지 말고, source_extraction/behavior_change와 기사 본문을 바탕으로 Gemini가 새로 작성하세요. 단, headline과 lead/body는 source-confirmed 핵심 변경점을 누락하거나 generic CameraX/Android framing으로 대체하면 안 됩니다.',
    'editorial_story fields: reader_scenario, what_happened, why_it_matters, field_scenario, not_to_overclaim, editor_take.',
    'body_paragraphs는 기사 본문입니다. 현업 장면, 확인된 변화, 왜 중요한지, 디버깅/리뷰 맥락을 중간 제목 없이 자연스러운 문단으로 합쳐 쓰세요.',
    '공개 기사에는 "현업 장면", "확인된 변화", "왜 봐야 하나", "디버깅/리뷰 시나리오", "편집자 판단", "과장 금지" 같은 라벨 문구를 쓰지 마세요. 공개 렌더링은 "Camera HAL / Driver 관점에서 확인할 점" 섹션만 따로 둡니다.',
