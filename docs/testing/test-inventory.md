...
| --- | --- | --- | --- | --- | --- | --- |
| `tests/aosp-camera-scope.test.js` | `unit` | Camera relevance bucket classification. | Inline sample. | `none` | `tests/unit/collect/` | Scope/classifier test와 가까운 위치로 이동합니다. |
