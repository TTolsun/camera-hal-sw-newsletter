...
> Archived note. This document reflects an older implementation state and must not be used as current operational guidance.
> Current guidance lives in `README.md`, `docs/START_HERE.ko.md`, and `docs/newsroom-workflow.md`.
