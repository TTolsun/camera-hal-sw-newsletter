...
이 폴더는 현재 운영 문서, 설정 문서, source guide, testing 기록, 계획 문서, archive note를 둡니다. 현재 guidance와 historical note를 혼동하지 않는 것이 가장 중요합니다.
...
- 새 계획 기록은 official docs로 남길 필요가 있을 때만 `docs/plans/**`에 둡니다.
