...
그 밖의 markdown 문법은 결정론 lint가 거부하며 발행이 막힙니다. 다른 단계의 헤딩, 리스트 마커, 인용, 수평선, 링크, 이미지, 코드 블록과 백틱, HTML 태그, 볼드 표기가 모두 여기에 해당합니다. 강조는 볼드가 아니라 문장 구조로 합니다. 중요한 사실은 문장의 주어 자리에 놓거나 짧은 단독 문단으로 분리합니다.
