...
| 2026-05-05 | Firebase AI Logic 하이브리드 추론: Camera HAL 입력 경로와 NPU/GPU 스케줄링 영향 | firebase-ai-logic-camera-hal-npu-gpu | yes | partial | low | generic | high | weak | historical_unreviewed | rewrite_review | S1 | AI platform item may overstate Camera HAL runtime impact |
