...
## 2. Android Studio, 개발자 선택에 따른 다양한 AI 코딩 에이전트 통합 기능 발표


![Android Studio, 개발자 선택에 따른 다양한 AI 코딩 에이전트 통합 기능 발표 image](../../assets/images/fallback/ai.svg)


_Android Developers Blog (2026년 9월 24일)_
...
## 3. Renesas RZ/V2H EVK 보드, Arm Mali-C55 ISP 및 IVC 하드웨어 활성화 패치 제안


![Renesas RZ/V2H EVK 보드, Arm Mali-C55 ISP 및 IVC 하드웨어 활성화 패치 제안 image](../../assets/images/fallback/android.svg)


_lore.kernel.org linux-media list (2026년 9월 25일)_
...
## 4. Samsung S5K3T2 20메가픽셀 이미지 센서, 리눅스 커널 드라이버 추가 패치 제안


![Samsung S5K3T2 20메가픽셀 이미지 센서, 리눅스 커널 드라이버 추가 패치 제안 image](../../assets/images/fallback/newsletter-default.svg)


_lore.kernel.org linux-media list (2026년 9월 24일)_
...
## 5. Intel IPU7 드라이버, 디바이스 제거 시 ISYS 펌웨어 리소스 누수 수정 패치 제안


![Intel IPU7 드라이버, 디바이스 제거 시 ISYS 펌웨어 리소스 누수 수정 패치 제안 image](../../assets/images/fallback/newsletter-default.svg)


_lore.kernel.org linux-media list (Intel IPU) (2026년 9월 24일)_
...
## 6. CameraX 1.6.2 릴리스, Android 17 동적 범위 충돌 및 주요 기기별 호환성 버그 해결 (5주 전 릴리스)


![CameraX 1.6.2 릴리스, Android 17 동적 범위 충돌 및 주요 기기별 호환성 버그 해결](https://developer.android.com/static/images/social/android-developers.png)

_이미지: [Android Developers Latest Updates](https://developer.android.com/jetpack/androidx/releases/camera#1.6.2)_


_Android Developers Latest Updates (2026년 8월 26일)_
...
- [CameraX Release Notes - CameraX 1.6.2](https://developer.android.com/jetpack/androidx/releases/camera#1.6.2)
