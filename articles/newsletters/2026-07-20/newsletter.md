# AOSP Camera / Driver / SoC Platform 뉴스레터 - 2026-07-20
...
- libcamera 패치워크에 IMX335 이미지 센서의 테스트 패턴 속성을 추가하는 패치가 제안되어 검토 중입니다.
- 해당 패치는 드라이버 수준에서 표준화된 테스트 패턴을 정의하여 이미지 파이프라인 검증 및 디버깅 편의성을 높이는 것을 목표로 합니다.
- Android Camera HAL 개발팀은 하위 드라이버 및 미디어 스택의 호환성 준비 관점에서 이 흐름을 관찰하고 로컬 검증 경로를 점검할 필요가 있습니다.
