...
| 매니페스트 날짜 | 경로 규약 | 예 |
|------|------|------|
| 2026-06-13 이전 | `articles/` 접두 **없음** — 그 시점에는 공개 출력물이 저장소 루트에 있었습니다 | `content/newsroom/...`, `data/newsletters.json`, `newsletters/...`, `sitemap.xml` |
| 2026-06-14 이후 | 저장소 루트 기준 | `articles/content/newsroom/...`, `articles/data/newsletters.json`, `state/article-exposure-history.json` |

실제로 커밋된 매니페스트는 옛 규약 8개(2026-05-28~06-11)와 루트 기준 13개(2026-06-16~08-17)이고, 2026-06-12~06-15 날짜의 매니페스트는 없습니다. 그런데도 경계를 첫 관측 날짜인 06-16이 아니라 **06-14로 잡은 이유는 규약을 바꾼 원인이 관측이 아니라 머지이기 때문입니다.** #262 phase 6은 `42fd4ba1`, 2026-06-13 12:29 KST에 머지됐습니다. 그러므로 06-14 이후 날짜의 매니페스트는 나중에 backfill이나 replay로 만들어져도 생산자가 루트 기준으로 씁니다. 06-13은 그날 정기 run이 머지보다 먼저 돌았으므로 옛 규약 쪽에 둡니다.
