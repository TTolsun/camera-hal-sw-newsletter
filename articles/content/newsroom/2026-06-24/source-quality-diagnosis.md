...
| lore.kernel.org linux-media list | 8 | 0 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
...
| --- | --- | --- | --- |
| missing_optional_artifact | articles/content/newsroom/2026-06-24/evidence-pack-summary.json not found; partial diagnosis will continue. | articles/content/newsroom/2026-06-24/evidence-pack-summary.json |  |
