...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Android Native Tooling: Build native Android apps in Google AI Studio | strong_signal | measurable_test | measurable_test | native_tooling_workflow, framework_hal_contract, driver_image_pipeline, stream_buffer_metadata, cts_vts_its_cdd, soc_resource_contention, camerax_app_compatibility | yes | none |
