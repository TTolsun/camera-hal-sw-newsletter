...
- Sources: 71 (registry=70, synthetic=1)
...
- Recommendations: NO_RECENT_SIGNAL: 51, OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR: 2, KEEP: 1, KEEP_AND_FIX_PARSER: 15, KEEP_AND_MONITOR: 2
- Selected main source quality coverage: 5/5
- Main-eligible source quality coverage: 3/3
- Conditional source promoted/blocked: 0/15
...
| Metric | Key | Count |
| --- | --- | --- |
| source_url_quality | project_mailing_list_release | 13 |
| source_url_quality | official_dated_release | 12 |
| source_url_quality | official_site_update_row | 5 |
| source_url_quality | undated_reference_page | 5 |
| source_url_quality | generic_ai_or_it_trend | 2 |
| source_url_quality | official_documentation_reference | 1 |
| source_url_quality | official_release_note_anchor | 1 |
| source_url_quality | project_release | 1 |
| source_quality_status | blocked | 35 |
| source_quality_status | allowed | 5 |
| blocker | source_gap_risk | 30 |
| blocker | reference_only | 22 |
| blocker | cross_check_required_but_missing | 13 |
| blocker | undated_reference_page | 5 |
| blocker | fallback_without_concrete_source_fact | 1 |
...
| --- | --- | --- | --- | --- | --- |
| android-developers-latest-updates | OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR | 1 | 0 | 1 | No RSS item, no published date, no concrete release/API/behavior change detected. |
| synthetic-android-version-features | OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR | 1 | 0 | 1 | Review source-change-events artifacts before using this candidate. |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 8 | 3 | 5 | finalSelectionEligibility=exclude |
| patchwork-libcamera-patches | KEEP_AND_FIX_PARSER | 5 | 1 | 4 | main_eligible=false |
...
| android-mediarecorder-reference | KEEP_AND_FIX_PARSER | 1 | 0 | 1 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
| android-photo-picker-reference | KEEP_AND_FIX_PARSER | 1 | 0 | 1 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| android-supported-formats-reference | KEEP_AND_FIX_PARSER | 1 | 0 | 1 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| android-developers-latest-updates | OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR | 0 | 1 | 0 | 0 | 0 | 1 | 0 | 0 |
| synthetic-android-version-features | OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR | 0 | 1 | 0 | 0 | 0 | 1 | 0 | 0 |
| camerax-release-notes | KEEP | 87.5 | 2 | 1 | 0.5 | 1 | 0 | 0 | 0 |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 22.5 | 8 | 0.375 | 1 | 0 | 0.625 | 0 | 0 |
| patchwork-libcamera-patches | KEEP_AND_FIX_PARSER | 4 | 5 | 0.2 | 1 | 0 | 0.8 | 0.4 | 0 |
...
| android-mediarecorder-reference | KEEP_AND_FIX_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
| android-photo-picker-reference | KEEP_AND_FIX_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
| android-security-bulletin | KEEP_AND_FIX_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
| android-supported-formats-reference | KEEP_AND_FIX_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
...
| raspberrypi-libcamera-releases | KEEP_AND_MONITOR | 35 | 1 | 1 | 0 | 0 | 0 | 0 | 0 |

## Warnings

- Ambiguous source domain developer.android.com matched registry sources android-developer-newsletter, android-developers-latest-updates, android-mediacodec-reference, android-mediarecorder-reference, android-mediastore-reference, android-photo-picker-reference, android-supported-formats-reference, androidx-media3-release-notes, camerax-release-notes.
- Unregistered candidate source grouped as synthetic-android-version-features.
