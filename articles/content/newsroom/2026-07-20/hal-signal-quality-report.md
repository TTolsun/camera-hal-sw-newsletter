# HAL Signal Quality Report - 2026-07-20
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | libcamera: IMX335 이미지 센서 테스트 패턴 속성 추가 패치 제안 | strong_signal | measurable_test | measurable_test | driver_image_pipeline | yes | none |
