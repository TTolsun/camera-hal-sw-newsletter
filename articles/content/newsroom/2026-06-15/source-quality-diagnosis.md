...
| 분류 체계 누락 | `taxonomy_missing` | true | 18 camera-relevant candidate(s) were not mapped to a known camera bucket. |
...
| --- | --- | --- | --- |
| missing_optional_artifact | articles/content/newsroom/2026-06-15/evidence-pack-summary.json not found; partial diagnosis will continue. | articles/content/newsroom/2026-06-15/evidence-pack-summary.json |  |
