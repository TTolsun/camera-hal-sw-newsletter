...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Android CLI 및 GitHub에 CameraX 마이그레이션 등 17개 이상의 신규 'Android 스킬' 공식 추가 | 있음 | 1 | 1 | 대표 이미지 선택됨 (selected) |
...
- 1. Android CLI 및 GitHub에 CameraX 마이그레이션 등 17개 이상의 신규 'Android 스킬' 공식 추가: 렌더 결과 불일치 (render_mismatch)
