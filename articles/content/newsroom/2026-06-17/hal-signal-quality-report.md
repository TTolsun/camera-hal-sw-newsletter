# HAL Signal Quality Report - 2026-06-17
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | CameraX 1.6.1 릴리스: ListenableFuture 컴파일 에러 수정 및 기기별 카메라 오동작 해결 | strong_signal | owner_metric_log | owner_metric_log | framework_hal_contract, stream_buffer_metadata | yes | none |
| 2 | Camera_ITS_문서_업데이트:_Honor_Pad_20_태블릿_허용_목록_추가_및_장면_실행_지침_재정렬 | usable_signal | concrete_check | concrete_check | cts_vts_its_cdd | yes | none |
