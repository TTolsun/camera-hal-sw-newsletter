...
| --- | --- | --- | --- | --- | --- | --- |
| android-developers-blog | KEEP_AND_FIX_PARSER | 35 | 8 | 4 | 2 | 1 |
...
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 8 | 4 | 6 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 35 | 8 | 0.5 | 0.5 | 0.5 | 0.5 | 0.375 | 0 |
| android-developers-latest-updates | KEEP_AND_FIX_PARSER | 5 | 2 | 0.5 | 0 | 0 | 0.5 | 0 | 0 |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 1.25 | 8 | 0.5 | 0.5 | 0 | 0.75 | 0.5 | 0 |
