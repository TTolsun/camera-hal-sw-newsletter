...
| 분류 체계 누락 | `taxonomy_missing` | true | 2 camera-relevant candidate(s) were not mapped to a known camera bucket. |
...
| --- | --- | --- | --- |
| missing_optional_artifact | content/newsroom/2026-06-06/evidence-pack-summary.json not found; partial diagnosis will continue. | content/newsroom/2026-06-06/evidence-pack-summary.json |  |
