...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | CameraX 1.6.0 정식 릴리스: 유스케이스 조합 지원 사전 쿼리 API 도입 및 기기별 스트림/버퍼 호환성 패치 대거 반영 | weak_signal | none | concrete_check | framework_hal_contract, driver_image_pipeline, stream_buffer_metadata, camerax_app_compatibility | yes | none |
