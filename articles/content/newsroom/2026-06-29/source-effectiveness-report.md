...
- Sources: 65 (registry=65, synthetic=0)
...
- Recommendations: NO_RECENT_SIGNAL: 42, OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR: 1, KEEP_AND_FIX_PARSER: 19, DOWNGRADE_TO_CANDIDATE_ONLY: 1, REVIEW_SOURCE_OR_PARSER: 1, KEEP_AND_MONITOR: 1
- Selected main source quality coverage: 2/2
- Main-eligible source quality coverage: 3/3
- Conditional source promoted/blocked: 0/18
...
| Metric | Key | Count |
| --- | --- | --- |
| source_url_quality | official_dated_release | 15 |
...
| source_url_quality | tech_media_lead_requires_cross_check | 4 |
...
| --- | --- | --- | --- | --- | --- | --- |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 45 | 8 | 2 | 2 | 2 |
...
| --- | --- | --- | --- | --- | --- |
| phoronix-linux-camera-media | DOWNGRADE_TO_CANDIDATE_ONLY | 3 | 1 | 1 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 45 | 8 | 0.25 | 1 | 1 | 0.75 | 0.5 | 0 |
...
| phoronix-linux-camera-media | DOWNGRADE_TO_CANDIDATE_ONLY | 0 | 3 | 0 | 0 | 0 | 1 | 1 | 0 |
| lwn-camera-media-articles | REVIEW_SOURCE_OR_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
