...
- Sources: 69 (registry=68, synthetic=1)
- Collected candidates: 40
- Unregistered candidates: 2
- Eligible candidates: 15
- Selected candidates: 5
- Rendered main articles: 4
- Source gap candidates: 25
- Generic noise candidates: 17
- Duplicate candidates: 0
- Recommendations: NO_RECENT_SIGNAL: 55, OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR: 2, KEEP: 1, KEEP_AND_FIX_PARSER: 9, KEEP_AND_MONITOR: 2
- Selected main source quality coverage: 5/5
- Main-eligible source quality coverage: 9/9
- Conditional source promoted/blocked: 0/16
...
| --- | --- | --- | --- | --- | --- | --- |
| lore-linux-media-list | KEEP | 84.63 | 8 | 8 | 5 | 4 |
...
| synthetic-aosp-camera-its-release-notes | OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR | 2 | 0 | 2 | Review source-change-events artifacts before using this candidate. |
| patchwork-libcamera-patches | KEEP_AND_FIX_PARSER | 8 | 5 | 3 | Excluded or low-confidence item below the main/short candidate tier. |
...
| synthetic-aosp-camera-its-release-notes | OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR | 0 | 2 | 0 | 0 | 0 | 1 | 0 | 0 |
| lore-linux-media-list | KEEP | 84.63 | 8 | 1 | 0.625 | 0.8 | 0 | 0 | 0 |
| patchwork-libcamera-patches | KEEP_AND_FIX_PARSER | 12.5 | 8 | 0.625 | 0 | 0 | 0.375 | 0 | 0 |
...
- Ambiguous source domain source.android.com matched registry sources android-compatibility-definition-document, android-security-bulletin, aosp-camera-documentation, aosp-site-updates, aosp-whats-new-release-notes.
