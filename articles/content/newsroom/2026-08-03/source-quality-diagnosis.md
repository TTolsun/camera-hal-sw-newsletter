...
| 분류 체계 누락 | `taxonomy_missing` | true | 24 camera-relevant candidate(s) were not mapped to a known camera bucket. |
...
| libcamera Patchwork (patch review) | 8 | 5 | Excluded or low-confidence item below the main/short candidate tier.; finalSelectionEligibility=exclude | 소스 유지, 파서 수정 |
...
| Unregistered source: aosp-camera-its-release-notes | 2 | 0 | Review source-change-events artifacts before using this candidate.; Source snapshot event is review/watchlist only because date evidence is weak or diagnostic. | 소스 유지, 파서 수정 |
...
| --- | --- | --- | --- |
| missing_optional_artifact | articles/content/newsroom/2026-08-03/evidence-pack-summary.json not found; partial diagnosis will continue. | articles/content/newsroom/2026-08-03/evidence-pack-summary.json |  |
