...
| 분류 체계 누락 | `taxonomy_missing` | true | 28 camera-relevant candidate(s) were not mapped to a known camera bucket. |
| Fallback 기사만 남음 | `fallback_only_composition` | false | 진단 신호 없음 |
| Source discovery 중복 또는 무효 | `duplicate_or_noop_source_discovery` | true | Gemini discovery produced 14 candidate(s) but gemini_new_unique_url_count=0. |
...
| libcamera Patchwork (patch review) | 7 | 2 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
...
| --- | --- | --- | --- |
| missing_optional_artifact | articles/content/newsroom/2026-08-10/evidence-pack-summary.json not found; partial diagnosis will continue. | articles/content/newsroom/2026-08-10/evidence-pack-summary.json |  |
