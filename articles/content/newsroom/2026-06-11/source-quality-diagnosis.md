...
| 분류 체계 누락 | `taxonomy_missing` | true | 17 camera-relevant candidate(s) were not mapped to a known camera bucket. |
...
| --- | --- | --- | --- | --- |
| Android Developers Blog | 8 | 4 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
...
| --- | --- | --- | --- |
| missing_optional_artifact | content/newsroom/2026-06-11/evidence-pack-summary.json not found; partial diagnosis will continue. | content/newsroom/2026-06-11/evidence-pack-summary.json |  |
