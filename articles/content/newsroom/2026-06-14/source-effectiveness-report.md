...
- Recommendations: NO_RECENT_SIGNAL: 49, OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR: 1, KEEP_AND_FIX_PARSER: 10, KEEP_AND_MONITOR: 2
...
| blocker | source_gap_risk | 25 |
| blocker | reference_only | 18 |
...
| --- | --- | --- | --- | --- | --- | --- |
| android-developers-blog | KEEP_AND_FIX_PARSER | 43.75 | 8 | 4 | 1 | 1 |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 8 | 4 | 4 | main_eligible=false |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 8 | 5 | 5 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 43.75 | 8 | 0.5 | 0.25 | 1 | 0.5 | 0.375 | 0 |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 8.75 | 8 | 0.625 | 0.4 | 0 | 0.625 | 0.375 | 0 |
