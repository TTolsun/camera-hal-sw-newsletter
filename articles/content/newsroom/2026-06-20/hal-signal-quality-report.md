# HAL Signal Quality Report - 2026-06-20
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Linux 커널에 Himax HM1246 이미지 센서 드라이버 추가를 위한 v10 패치 제안 | usable_signal | concrete_check | concrete_check | driver_image_pipeline | yes | none |
| 2 | GCC 16 컴파일러 릴리스 예정: 개선된 오류 메시지 및 SARIF 출력 기능 추가 | usable_signal | none | concrete_check | native_tooling_workflow | yes | none |
