...
- 이미지 후보 수 (`image_candidates_count`): 7
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Linux 커널에 Himax HM1246 이미지 센서 드라이버 v10 패치 제안 | 없음 | 6 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
| 2 | GCC 16 컴파일러, 개선된 오류 메시지와 SARIF 출력 기능 도입 예정 | 있음 | 1 | 1 | 대표 이미지 선택됨 (selected) |
