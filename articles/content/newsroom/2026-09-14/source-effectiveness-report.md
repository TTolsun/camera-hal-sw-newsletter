...
- Sources: 74 (registry=74, synthetic=0)
- Collected candidates: 40
- Unregistered candidates: 0
- Eligible candidates: 25
- Selected candidates: 5
- Rendered main articles: 4
- Source gap candidates: 15
- Generic noise candidates: 7
- Duplicate candidates: 0
- Recommendations: NO_RECENT_SIGNAL: 65, KEEP: 1, KEEP_AND_FIX_PARSER: 1, REVIEW_SOURCE_OR_PARSER: 4, KEEP_AND_MONITOR: 3
- Selected main source quality coverage: 5/5
- Main-eligible source quality coverage: 5/5
- Conditional source promoted/blocked: 0/24
...
| Metric | Key | Count |
| --- | --- | --- |
| source_url_quality | project_mailing_list_release | 27 |
...
| blocker | source_gap_risk | 15 |
| blocker | reference_only | 7 |
...
| --- | --- | --- | --- | --- | --- | --- |
| lore-linux-media-list | KEEP | 72.14 | 8 | 7 | 2 | 2 |
| patchwork-libcamera-patches | REVIEW_SOURCE_OR_PARSER | 62.5 | 8 | 5 | 2 | 2 |
...
| lore-linux-media-list | KEEP | 72.14 | 8 | 0.875 | 0.2857 | 1 | 0.125 | 0.125 | 0 |
| android-security-bulletin | KEEP_AND_FIX_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
| patchwork-libcamera-patches | REVIEW_SOURCE_OR_PARSER | 62.5 | 8 | 0.625 | 0.4 | 1 | 0.375 | 0 | 0 |
| lore-linux-media-ipu | REVIEW_SOURCE_OR_PARSER | 11.25 | 8 | 0.5 | 0.25 | 0 | 0.5 | 0 | 0 |
| android-developers-latest-updates | REVIEW_SOURCE_OR_PARSER | 5 | 2 | 0.5 | 0 | 0 | 0.5 | 0 | 0 |
| android-developers-blog | REVIEW_SOURCE_OR_PARSER | 0 | 8 | 0.375 | 0 | 0 | 0.625 | 0.625 | 0 |
