...
| 소스 풀 부족 위험 | `source_gap_risk` | true | lore-linux-media-list has source coverage risk: source_gap_count=2. |
...
| --- | --- | --- | --- |
| missing_optional_artifact | articles/content/newsroom/2026-06-26/evidence-pack-summary.json not found; partial diagnosis will continue. | articles/content/newsroom/2026-06-26/evidence-pack-summary.json |  |
