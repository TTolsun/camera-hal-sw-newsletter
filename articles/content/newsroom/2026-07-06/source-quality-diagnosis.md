...
| libcamera Patchwork (patch review) | 8 | 1 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
...
| --- | --- | --- | --- |
| missing_optional_artifact | articles/content/newsroom/2026-07-06/evidence-pack-summary.json not found; partial diagnosis will continue. | articles/content/newsroom/2026-07-06/evidence-pack-summary.json |  |
