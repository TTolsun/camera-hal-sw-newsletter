...
- 이미지 후보 수 (`image_candidates_count`): 13
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Himax HM1246 이미지 센서용 V4L2 서브디바이스 드라이버 패치 v10 제안 | 없음 | 6 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
| 2 | Sony IMX576 이미지 센서용 V4L2 서브디바이스 드라이버 패치 v2 제안 | 없음 | 6 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
| 3 | GCC 16 릴리스 예정: 템플릿 오류 메시지 개선 및 SARIF 정적 분석 출력 지원 | 있음 | 1 | 1 | 대표 이미지 선택됨 (selected) |
