...
- Sources: 67 (registry=67, synthetic=0)
...
- Recommendations: NO_RECENT_SIGNAL: 49, OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR: 1, KEEP: 1, KEEP_AND_FIX_PARSER: 15, KEEP_AND_MONITOR: 1
- Selected main source quality coverage: 3/3
- Main-eligible source quality coverage: 3/3
- Conditional source promoted/blocked: 0/17
...
| source_url_quality | official_dated_release | 13 |
...
| --- | --- | --- | --- | --- | --- | --- |
| raspberrypi-libcamera-releases | KEEP | 100 | 1 | 1 | 1 | 1 |
| patchwork-libcamera-patches | KEEP_AND_FIX_PARSER | 51.25 | 8 | 4 | 1 | 1 |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 30 | 8 | 1 | 1 | 1 |
...
| patchwork-libcamera-patches | KEEP_AND_FIX_PARSER | 8 | 4 | 4 | Excluded or low-confidence item below the main/short candidate tier. |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 8 | 1 | 7 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 8 | 2 | 6 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| raspberrypi-libcamera-releases | KEEP | 100 | 1 | 1 | 1 | 1 | 0 | 0 | 0 |
| patchwork-libcamera-patches | KEEP_AND_FIX_PARSER | 51.25 | 8 | 0.5 | 0.25 | 1 | 0.5 | 0 | 0 |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 30 | 8 | 0.125 | 1 | 1 | 0.875 | 0.875 | 0 |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 0 | 8 | 0.25 | 0 | 0 | 0.75 | 0.75 | 0 |
