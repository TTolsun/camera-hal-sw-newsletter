# Source Discovery Feedback Report - 2026-08-31

status=WARNING
parser_gap_count=2
duplicate_discovery_gap_count=0
gemini_parser_failure_count=4

| Action | Reason | Candidate | Adapter | Duplicate Discovery | Duplicate Match | Confidence | URL |
|---|---|---|---|---|---|---|---|
| PARSER_REPAIR_REQUIRED | missing_source_extraction | 1.0.0-alpha01 | android-developers-jetpack-release | false |  | high | https://developer.android.com/jetpack/androidx/releases/camera |
...
- PARSER_REPAIR_REQUIRED: 1.0.0-alpha01
