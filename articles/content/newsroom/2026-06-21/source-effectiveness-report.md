...
- Recommendations: NO_RECENT_SIGNAL: 47, OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR: 1, KEEP_AND_FIX_PARSER: 16, KEEP_AND_MONITOR: 1
- Selected main source quality coverage: 3/3
- Main-eligible source quality coverage: 5/5
- Conditional source promoted/blocked: 1/18
...
| blocker | source_gap_risk | 32 |
| blocker | reference_only | 29 |
| blocker | cross_check_required_but_missing | 9 |
...
| --- | --- | --- | --- | --- | --- | --- |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 40 | 8 | 2 | 2 | 2 |
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 37.5 | 8 | 1 | 1 | 1 |
...
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 8 | 2 | 6 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 8 | 1 | 7 | main_eligible=false |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 8 | 4 | 4 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 40 | 8 | 0.25 | 1 | 1 | 0.75 | 0.75 | 0 |
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 37.5 | 8 | 0.125 | 1 | 1 | 0.875 | 0.5 | 0 |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 0 | 8 | 0.5 | 0 | 0 | 0.5 | 0.5 | 0 |
