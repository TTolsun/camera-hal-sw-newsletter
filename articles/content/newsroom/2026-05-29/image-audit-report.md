...
- 이번 repair 실행 복원 수 (`repaired_in_this_run_count`): 2
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Google I/O 2026: Jetpack Compose와 CameraX로 구현하는 완벽한 적응형 카메라 미리보기 | 있음 | 1 | 1 | 대표 이미지 선택됨 (selected) |
| 2 | Google AI Studio: 프롬프트만으로 네이티브 Android 앱 빌드 및 AI 카메라 프로토타이핑 가속화 | 있음 | 1 | 1 | 대표 이미지 선택됨 (selected) |
