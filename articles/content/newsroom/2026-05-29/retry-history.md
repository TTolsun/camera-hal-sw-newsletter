...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | reporter=gemini-2.5-flash, editor=gemini-3.5-flash, public-article-judge=gemini-2.5-flash-lite, fact-checker=gemini-2.5-flash | 97/85 | PASS | 2 | 2 | 0 | 0 | 0 | 0 | 0 |
...
- 선택 기사: Google I/O 2026: Jetpack Compose와 CameraX 통합을 통한 적응형 카메라 미리보기 구현; Google AI Studio: 프롬프트 기반 네이티브 Android 앱 빌드 및 카메라 스트림 연동 워크플로
- Lock된 기사: Google I/O 2026: Jetpack Compose와 CameraX 통합을 통한 적응형 카메라 미리보기 구현; Google AI Studio: 프롬프트 기반 네이티브 Android 앱 빌드 및 카메라 스트림 연동 워크플로
...
- Lock blocker: 없음
- 거절된 중복 기사: 없음
- 감점: 1pt editorial-story (briefing 1): Briefing bullet misses story structure elements: action_hint.; 1pt image-fallback (Google I/O 2026: Jetpack Compose와 CameraX 통합을 통한 적응형 카메라 미리보기 구현): Article image uses a local fallback visual.; 1pt image-fallback (Google AI Studio: 프롬프트 기반 네이티브 Android 앱 빌드 및 카메라 스트림 연동 워크플로): Article image uses a local fallback visual.
