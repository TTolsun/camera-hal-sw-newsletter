...
- Sources: 74 (registry=73, synthetic=1)
...
- Generic noise candidates: 13
- Duplicate candidates: 0
- Recommendations: NO_RECENT_SIGNAL: 62, OFFICIAL_SOURCE_NEEDS_PARSER_REPAIR: 1, KEEP_AND_FIX_PARSER: 3, REVIEW_SOURCE_OR_PARSER: 5, KEEP_AND_MONITOR: 3
- Selected main source quality coverage: 5/5
- Main-eligible source quality coverage: 10/10
- Conditional source promoted/blocked: 0/20
...
| Metric | Key | Count |
| --- | --- | --- |
| source_url_quality | project_mailing_list_release | 19 |
...
| blocker | reference_only | 17 |
| blocker | policy_locked_out_of_main | 3 |
...
| --- | --- | --- | --- | --- | --- | --- |
| lore-linux-media-list | REVIEW_SOURCE_OR_PARSER | 65 | 8 | 5 | 3 | 3 |
| patchwork-libcamera-patches | REVIEW_SOURCE_OR_PARSER | 49.17 | 8 | 3 | 2 | 2 |
...
| claude-blog | KEEP_AND_FIX_PARSER | 2 | 0 | 2 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| claude-blog | KEEP_AND_FIX_PARSER | 0 | 2 | 0 | 0 | 0 | 1 | 1 | 0 |
| kernel-org-releases | KEEP_AND_FIX_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
| lore-linux-media-list | REVIEW_SOURCE_OR_PARSER | 65 | 8 | 0.625 | 0.6 | 1 | 0.375 | 0.125 | 0 |
| patchwork-libcamera-patches | REVIEW_SOURCE_OR_PARSER | 49.17 | 8 | 0.375 | 0.6667 | 1 | 0.625 | 0.25 | 0 |
| raspberrypi-libcamera-releases | REVIEW_SOURCE_OR_PARSER | 5 | 2 | 0.5 | 0 | 0 | 0.5 | 0 | 0 |
| synthetic-aosp-camera-its-release-notes | REVIEW_SOURCE_OR_PARSER | 5 | 2 | 0.5 | 0 | 0 | 0.5 | 0 | 0 |
| android-developers-blog | REVIEW_SOURCE_OR_PARSER | 0 | 8 | 0.25 | 0 | 0 | 0.75 | 0.75 | 0 |
| aosp-camera-documentation | KEEP_AND_MONITOR | 35 | 1 | 1 | 0 | 0 | 0 | 0 | 0 |
| aosp-gerrit-camera-changes | KEEP_AND_MONITOR | 35 | 3 | 1 | 0 | 0 | 0 | 0 | 0 |
