...
| 분류 체계 누락 | `taxonomy_missing` | true | 15 camera-relevant candidate(s) were not mapped to a known camera bucket. |
...
| lore.kernel.org linux-media list | 8 | 0 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.; briefing_only=true | 소스 유지, 파서 수정 |
...
| --- | --- | --- | --- |
| missing_optional_artifact | articles/content/newsroom/2026-06-16/evidence-pack-summary.json not found; partial diagnosis will continue. | articles/content/newsroom/2026-06-16/evidence-pack-summary.json |  |
