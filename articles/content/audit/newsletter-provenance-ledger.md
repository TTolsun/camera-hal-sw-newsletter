...
- 2026-05-22 / 05-23 / 05-25 / 05-26 / 05-29 / 05-30 / 05-31 / 06-02 / 06-06 / 06-16 / 06-20 / 06-21 / 06-22 / 06-24 와 2026-W21 / W22 / W23 / W24 / W25 / W26 / W28 / W29 는 roundup child 제목 정규화를 받았습니다. 수집기가 `<섹션 heading> - <부모 문서 제목>` 으로 조립해 어느 페이지에도 없는 제목이 되어 버린 3종을, 현재 수집기가 내는 표기 `<섹션 heading> (『<부모 문서 제목>』)` 로 바꿨습니다(#857, 전방 수정은 #926). 제목 문자열만 교체했고 URL·본문·재렌더는 없어 article body 의미가 바뀌지 않으므로 material rewrite diff는 추가하지 않았습니다.
