...
// AI Engineering 학습 페이지) 목록을 먼저 두고, weekly 발행물은 그 뒤에 열거한다.
...
const AI_ENGINEERING_LEARNING_PATH = 'learning/ai-engineering/';
...
// 발행 데이터와 무관한 안정적인 public entry point를 담는 정적 sitemap.
function buildStaticSitemap() {
  return renderSitemapXml(staticSitemapEntries());
}

// stable entry points + 각 weekly 발행물을 enumerate한다. 발행물 목록은 라이브 사이트가 쓰는
