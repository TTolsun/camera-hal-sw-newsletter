...
// not_checked로 남는다(실측 2026-09-14: weak_candidate 버킷의 android dev blog). 이 게이트가
// 들어오면 그 fetch 대상 선정 기준이 사실상 main 자격 조건이 된다. 같은 문서의 클러스터 형제
// (같은 릴리스 페이지의 다른 anchor, 09-14의 CameraX 1.6.2)는 대표의 수신 결과를 물려받으므로
// (validate-candidate-evidence.js, #1136) 이 게이트에 걸리지 않는다.
//
