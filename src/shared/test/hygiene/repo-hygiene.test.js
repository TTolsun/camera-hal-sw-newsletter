...
test('findRepoHygieneIssues reports stray tests outside src/<layer>/test/ even when allowlisted', () => {
  const issues = findRepoHygieneIssues([
    ...
    'src/shared/test/unit/baz.test.js'
  ], {
    rootTestAllowlist: ['src/shared/foo.test.js']
  });
...
test('findRepoHygieneIssues reports non-empty root test allowlist entries as migration debt', () => {
  const issues = findRepoHygieneIssues(['src/shared/test/unit/not-root.test.js'], {
    rootTestAllowlist: [
      'src/shared/foo.test.js',
      'src/shared/test/missing.test.js',
      'src/shared/test/unit/not-root.test.js'
    ]
  });
