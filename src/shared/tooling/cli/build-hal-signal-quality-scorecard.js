...
} = require('../../../generator/diagnostics/hal-signal-quality-report');

function usage() {
  return [
    'Usage: node src/shared/tooling/cli/build-hal-signal-quality-scorecard.js --dates YYYY-MM-DD[,YYYY-MM-DD...] [--output path]',
    '',
