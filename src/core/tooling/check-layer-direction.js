...
// 의도된 의존 방향은 단방향입니다: core <- collector <- discovery <- generator.
// 즉 generator 는 discovery/collector/core 에 의존할 수 있고, core 는 그 무엇에도
...
// 이 파일은 <repo>/src/core/tooling/check-layer-direction.js 입니다.
...
// src/<layer>/**/*.js 중 src/**/test/** 와 src/core/tooling/** 은 제외합니다.
...
function isProductionLayerFile(repoRelativePath) {
  ...
  if (parts[1] === 'core' && parts[2] === 'tooling') {
    return false;
  }
  return true;
}
