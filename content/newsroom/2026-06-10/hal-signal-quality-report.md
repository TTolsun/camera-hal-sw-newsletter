# HAL Signal Quality Report - 2026-06-10
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Android 개발자 생산성 도구 'Android skills' 저장소 확장 및 CameraX 마이그레이션 지원 추가 | usable_signal | none | concrete_check | camerax_app_compatibility | yes | none |
