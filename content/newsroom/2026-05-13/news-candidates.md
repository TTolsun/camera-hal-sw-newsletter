...
| watchlist | generic_tech_watchlist | 6 | 44 | 8 | release-note-item | yes | release_note_item | Claude Code Changelog | Claude Code Changelog - 2.1.139 | May 11, 2026 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. | [link](https://code.claude.com/docs/en/changelog) |
...
### 6. Streamline User Journeys with Verified Email via Credential Manager
...
### 22. Behold the power of meta::substitute -- Barry Revzin
...
### 32. Claude Code Changelog - 2.1.139
...
- Source gap risk: yes
- Evidence score: 8
- Version/release: 2.1.139
- API/component: Claude Code
- Behavior change: ​ 2.1.139 May 11, 2026 Added agent view (Research Preview): a single list of every Claude Code session — running, blocked on you, or done.
- Cross-check 필요: no
- Selection exclusion reason: Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.
- Verification hint: Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.
- Relevance Score: 44
- 요약: ​ 2.1.139 May 11, 2026 Added agent view (Research Preview): a single list of every Claude Code session — running, blocked on you, or done.
