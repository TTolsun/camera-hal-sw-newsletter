...
- Recommendations: NO_RECENT_SIGNAL: 56, KEEP_AND_FIX_PARSER: 6
...
| Metric | Key | Count |
| --- | --- | --- |
| source_url_quality | official_dated_release | 20 |
| source_url_quality | project_mailing_list_release | 12 |
...
| blocker | candidate_only_without_primary_confirmation | 12 |
| blocker | cross_check_required_but_missing | 12 |
...
| --- | --- | --- | --- | --- | --- | --- |
| android-developers-blog | KEEP_AND_FIX_PARSER | 28.95 | 19 | 2 | 2 | 2 |

## Sources Needing Parser Repair

| Source | Recommendation | Collected | Eligible | Source Gap | Top Reason |
| --- | --- | --- | --- | --- | --- |
| android-developers-blog | KEEP_AND_FIX_PARSER | 19 | 2 | 17 | main_eligible=false |
...
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 12 | 0 | 12 | main_eligible=false |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 28.95 | 19 | 0.1053 | 1 | 1 | 0.8947 | 0.8421 | 1 |
...
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 0 | 5 | 0 | 0 | 0 | 1 | 0.4 | 0 |
| lore-linux-media-list | KEEP_AND_FIX_PARSER | 0 | 12 | 0 | 0 | 0 | 1 | 0.75 | 0 |
