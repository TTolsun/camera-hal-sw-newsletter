# HAL Signal Quality Report - 2026-05-17
...
- article_count_without_hal_signal_capsule: 3
- generic_signal_hard_blocker_count: 0
- hal_signal_hard_blocker_count: 3
- hard_blocker_reason_code_counts: {"hal_signal_capsule_missing":3}
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | libcamera Release Announcements - libcamera v0.7.1 | strong_signal | owner_metric_log | owner_metric_log | driver_image_pipeline, framework_hal_contract, stream_buffer_metadata, cts_vts_its_cdd, performance_latency_frame_drop, soc_resource_contention, camerax_app_compatibility | no | hal_signal_capsule_missing |
| 2 | Tooling Watch / Fallback: GCC 16.1 released: C++26 reflection / contracts / safety hardening, C++20 by default, and more! | strong_signal | measurable_test | measurable_test | native_tooling_workflow, framework_hal_contract, driver_image_pipeline, stream_buffer_metadata, cts_vts_its_cdd, camerax_app_compatibility | no | hal_signal_capsule_missing |
| 3 | Tooling Watch / Fallback: Glaze 7.2 - C++26 Reflection \| YAML, CBOR, MessagePack, TOML and more | strong_signal | measurable_test | measurable_test | native_tooling_workflow, framework_hal_contract, driver_image_pipeline, stream_buffer_metadata, cts_vts_its_cdd, camerax_app_compatibility | no | hal_signal_capsule_missing |
