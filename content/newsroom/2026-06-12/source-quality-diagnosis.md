...
| Source discovery 중복 또는 무효 | `duplicate_or_noop_source_discovery` | true | Duplicate discovery signal detected: gemini_manual_duplicate_url_count=7, duplicate_discovery_gap_count=1. |
...
| lore.kernel.org linux-media list | 8 | 6 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.; briefing_only=true | 소스 유지, 파서 수정 |
...
| --- | --- | --- | --- |
| missing_optional_artifact | content/newsroom/2026-06-12/evidence-pack-summary.json not found; partial diagnosis will continue. | content/newsroom/2026-06-12/evidence-pack-summary.json |  |
