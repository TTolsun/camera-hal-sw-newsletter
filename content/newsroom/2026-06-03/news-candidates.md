...
| reference | reference | generic_tech_watchlist | Building Premium Android Experiences at Google I/O ‘26 | Android Developers Blog | Tue, 02 Jun 2026 17:00:00 +0000 | Background reference page; not an article candidate. | [link](https://android-developers.googleblog.com/2026/06/building-premium-android-experiences-google-io-26.html) |
...
| reference | reference | generic_tech_watchlist | [PATCH v16 2/6] rust: drm: gem: Add vmap functions to shmem bindings | lore.kernel.org linux-media list | 2026-06-02T17:28:34Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/20260602172807.1051806-3-lyude@redhat.com/) |
| reference | reference | generic_tech_watchlist | [PATCH v16 0/6] Rust bindings for gem shmem | lore.kernel.org linux-media list | 2026-06-02T17:28:25Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/20260602172807.1051806-1-lyude@redhat.com/) |
...
| reference | reference | generic_tech_watchlist | [PATCH v16 5/6] rust: faux: Allow retrieving a bound Device | lore.kernel.org linux-media list | 2026-06-02T17:28:45Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/20260602172807.1051806-6-lyude@redhat.com/) |
| reference | reference | generic_tech_watchlist | Re: [PATCH v2 9/9] vfio/pci: Add mmap() attributes to DMABUF feature | lore.kernel.org linux-media list | 2026-06-02T16:50:11Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/8854824e-06c2-43b3-86c2-8c2c28f9ad63@meta.com/) |
| reference | reference | generic_tech_watchlist | Re: [PATCH 2/2] arm64: dts: qcom: hamoa: Reserve low IOVA range for Iris | lore.kernel.org linux-media list | 2026-06-02T15:35:45Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/CAMVG2ssnyH=KUKrdfnUOtPYU7p17inyzcYWcKhT4EAZxDzDjfg@mail.gmail.com/) |
...
### 3. 17 Things to know for Android developers at Google I/O
...
### 4. Android UI Development is Compose First
...
### 5. Top AI on Android updates for building intelligent experiences from Google I/O ‘26
...
### 6. Android CLI Now Stable 1.0: Accelerate developing for Android using any agent
...
### 7. Android Studio I/O Edition: What’s new in Android Developer tools
...
### 8. How FotMob leveraged cross-device discovery to score record Wear OS adoption
...
### 9. Build native Android apps in Google AI Studio
...
### 10. Increasing app discovery and engagement on Google TV
...
### 11. I/O 2026: What's new in Google Play
...
### 13. Building Premium Android Experiences at Google I/O ‘26

- 출처: Android Developers Blog
- 출처 URL: https://android-developers.googleblog.com/
- 발행일: Tue, 02 Jun 2026 17:00:00 +0000
- Link: https://android-developers.googleblog.com/2026/06/building-premium-android-experiences-google-io-26.html
- Section: Android / AOSP / Camera
- Selection: reference
- Evidence level: reference
- Topic: generic_tech_watchlist
- Reason: Background reference page; not an article candidate.
- 날짜 근거 있음: yes
- 요약: Posted by Ataul Munim, Android Developer Relations Engineer A truly differentiated Android experience is about delivering premium delight wherever your users are. At Google I/O ‘26, we showcased how the latest advancements in the Android ecosystem can help you elevate your app's quality while maximizing development efficiency. To help you build apps that stand out, we're diving into the key tools and libraries designed to optimize your core performance, extend the surfaces of your app to other d

### 14. Start building today - Build native Android apps in Google AI Studio
...
### 15. Build for the future with the Android XR Developer Catalyst Program — Apply now!
...
### 16. Adaptive development for the expanding Android ecosystem
...
### 17. Updates to the Android XR SDK: Introducing Developer Preview 4
...
### 18. Introducing Android Performance Analyzer : The Next Evolution in Profiling for Android
...
### 19. Bring Native Visibility to Your VoIP App Experience with Telecom's Latest Alpha
...
### 23. What's new in Android for Cars: Unifying platforms and unlocking premium experiences
...
### 27. How ref qualifiers led to deducing this
...
### 29. [PATCH v16 2/6] rust: drm: gem: Add vmap functions to shmem bindings

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-06-02T17:28:34Z
- Link: https://lore.kernel.org/linux-media/20260602172807.1051806-3-lyude@redhat.com/
...
- Reason: Background reference page; not an article candidate.
- 날짜 근거 있음: yes
- 요약: One of the more obvious use cases for gem shmem objects is the ability to create mappings into their contents. So, let's hook this up in our rust bindings. Signed-off-by: Lyude Paul --- V7: * Switch over to the new iosys map bindings that use the Io trait V8: * Get rid of iosys_map bindings for now, only support non-iomem types * s/as_shmem()/as_raw_shmem() V9: * Get rid of some outdated comments I missed * Add missing SIZE check to raw_vmap() * Add a proper unit test that ensures that we actual

### 30. [PATCH v16 0/6] Rust bindings for gem shmem

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-06-02T17:28:25Z
- Link: https://lore.kernel.org/linux-media/20260602172807.1051806-1-lyude@redhat.com/
- Section: Linux Camera / Driver
- Selection: reference
- Evidence level: reference
- Topic: generic_tech_watchlist
...
### 31. Upcoming C++ User Group meetings in June 2026
...
### 35. [PATCH v16 5/6] rust: faux: Allow retrieving a bound Device

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-06-02T17:28:45Z
- Link: https://lore.kernel.org/linux-media/20260602172807.1051806-6-lyude@redhat.com/
- Section: Linux Camera / Driver
- Selection: reference
- Evidence level: reference
- Topic: generic_tech_watchlist
...
### 36. Re: [PATCH v2 9/9] vfio/pci: Add mmap() attributes to DMABUF feature

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-06-02T16:50:11Z
- Link: https://lore.kernel.org/linux-media/8854824e-06c2-43b3-86c2-8c2c28f9ad63@meta.com/
- Section: Linux Camera / Driver
- Selection: reference
- Evidence level: reference
- Topic: generic_tech_watchlist
- Reason: Background reference page; not an article candidate.
- 날짜 근거 있음: yes
- 요약: Hi Alex, On 29/05/2026 00:14, Alex Williamson wrote: > > On Wed, 27 May 2026 03:23:12 -0700 > Matt Evans wrote: > >> A new VFIO feature, VFIO_DEVICE_FEATURE_DMA_BUF_MEMATTR, is added to >> set (and get) CPU-facing memory type attributes for a DMABUF exported >> from vfio-pci. These are used for subsequent mmap()s of the buffer. >> >> There are two attributes supported: >> - The default, VFIO_DEVICE_FEATURE_DMA_BUF_MEMATTR_UC >> - VFIO_DEVICE_FEATURE_DMA_BUF_MEMATTR_WC, which results in WC >> PTE

### 37. Re: [PATCH 2/2] arm64: dts: qcom: hamoa: Reserve low IOVA range for Iris

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-06-02T15:35:45Z
- Link: https://lore.kernel.org/linux-media/CAMVG2ssnyH=KUKrdfnUOtPYU7p17inyzcYWcKhT4EAZxDzDjfg@mail.gmail.com/
- Section: Linux Camera / Driver
- Selection: reference
- Evidence level: reference
- Topic: generic_tech_watchlist
