...
- hal_impact_axis_counts: {"native_tooling_workflow":2,"stream_buffer_metadata":3,"security_vendor_component":1,"cts_vts_its_cdd":1,"framework_hal_contract":1,"soc_resource_contention":1,"camerax_app_compatibility":1}
- actionability_level_counts: {"owner_metric_log":4}
- effective_actionability_level_counts: {"owner_metric_log":4}

| # | Article | signal_quality_status | actionability_level | effective_actionability_level | hal_impact_axes | HAL Signal Capsule | hard_blocker_reason_codes |
| ---: | --- | --- | --- | --- | --- | --- | --- |
| 1 | Claude Code 2.1.128 출시: agent-assisted Camera HAL 개발 워크플로우 영향 | strong_signal | owner_metric_log | owner_metric_log | native_tooling_workflow, stream_buffer_metadata | complete | none |
| 2 | 2026년 5월 Android 보안 게시판 발행: HAL 취약점 점검 필수 | strong_signal | owner_metric_log | owner_metric_log | security_vendor_component, cts_vts_its_cdd, framework_hal_contract | complete | none |
...
| 4 | C++26 assert() 개선: 네이티브 Camera HAL 코드 안정성 디버깅 신호 | strong_signal | owner_metric_log | owner_metric_log | native_tooling_workflow, stream_buffer_metadata | complete | none |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Code 2.1.128 출시: agent-assisted Camera HAL 개발 워크플로우 영향 | claude-code-2-1-128-agent-assisted-camera-hal-fact-1: 릴리스 날짜: 2026년 5월 4일 | fact | bound | native_tooling_workflow | low | none | historical-2026-05-05-claude-code-2-1-128-agent-assisted-camera-hal-primary | https://code.claude.com/docs/en/changelog |
| Claude Code 2.1.128 출시: agent-assisted Camera HAL 개발 워크플로우 영향 | claude-code-2-1-128-agent-assisted-camera-hal-fact-2: 버전/릴리스: Claude Code 2.1.128 | fact | bound | native_tooling_workflow | low | none | historical-2026-05-05-claude-code-2-1-128-agent-assisted-camera-hal-primary | https://code.claude.com/docs/en/changelog |
| Claude Code 2.1.128 출시: agent-assisted Camera HAL 개발 워크플로우 영향 | claude-code-2-1-128-agent-assisted-camera-hal-fact-3: API/구성 요소: Claude Code / AI coding agent | fact | bound | native_tooling_workflow | low | none | historical-2026-05-05-claude-code-2-1-128-agent-assisted-camera-hal-primary | https://code.claude.com/docs/en/changelog |
...
| 2026년 5월 Android 보안 게시판 발행: HAL 취약점 점검 필수 | 2026-5-android-hal-fact-1: 2026년 5월 Android 보안 게시판이 2026년 5월 1일에 발행되었습니다. | fact | bound | cts_vts_its_cdd | low | none | historical-2026-05-05-2026-5-android-hal-primary | https://source.android.com/docs/security/bulletin/asb-overview |
| 2026년 5월 Android 보안 게시판 발행: HAL 취약점 점검 필수 | 2026-5-android-hal-fact-2: 게시판은 Android 시스템의 보안 취약점 및 관련 패치 정보를 포함합니다. | fact | bound | cts_vts_its_cdd | low | none | historical-2026-05-05-2026-5-android-hal-primary | https://source.android.com/docs/security/bulletin/asb-overview |
| 2026년 5월 Android 보안 게시판 발행: HAL 취약점 점검 필수 | 2026-5-android-hal-fact-3: 2026년 5월 1일자 Android Security Bulletin에 따르면, 2026년 5월 Android 보안 게시판이 발행되었으며, 이는 Android 시스템의 보안 ... | fact | bound | cts_vts_its_cdd | low | none | historical-2026-05-05-2026-5-android-hal-primary | https://source.android.com/docs/security/bulletin/asb-overview |
...
| C++26 assert() 개선: 네이티브 Camera HAL 코드 안정성 디버깅 신호 | c-26-assert-camera-hal-fact-1: Release/version: C++26 (예정) | fact | bound | native_tooling_workflow | low | none | historical-2026-05-05-c-26-assert-camera-hal-primary | https://isocpp.org//blog/2026/05/cpp26-a-user-friendly-assert-macro-sandor-dargo |
| C++26 assert() 개선: 네이티브 Camera HAL 코드 안정성 디버깅 신호 | c-26-assert-camera-hal-fact-2: Release date: 2026년 5월 (제안 발표) | fact | bound | native_tooling_workflow | low | none | historical-2026-05-05-c-26-assert-camera-hal-primary | https://isocpp.org//blog/2026/05/cpp26-a-user-friendly-assert-macro-sandor-dargo |
| C++26 assert() 개선: 네이티브 Camera HAL 코드 안정성 디버깅 신호 | c-26-assert-camera-hal-fact-3: API/component: `assert()` 매크로 | fact | bound | native_tooling_workflow | low | none | historical-2026-05-05-c-26-assert-camera-hal-primary | https://isocpp.org//blog/2026/05/cpp26-a-user-friendly-assert-macro-sandor-dargo |
| C++26 assert() 개선: 네이티브 Camera HAL 코드 안정성 디버깅 신호 | c-26-assert-camera-hal-fact-4: Behavior change: `assert()` 매크로가 실패 시 더 많은 컨텍스트 정보(예: 변수 값, 표현식)를 자동으로 캡처하고 출력할 수 있도록 개선됩니다. 또한, ... | fact | bound | native_tooling_workflow | low | none | historical-2026-05-05-c-26-assert-camera-hal-primary | https://isocpp.org//blog/2026/05/cpp26-a-user-friendly-assert-macro-sandor-dargo |
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | Claude Code 2.1.128 출시: agent-assisted Camera HAL 개발 워크플로우 영향 | pass | present+guarded | native_tooling_workflow, stream_buffer_metadata | owner_metric_log | guardrail-only |
...
| 4 | C++26 assert() 개선: 네이티브 Camera HAL 코드 안정성 디버깅 신호 | pass | present+guarded | native_tooling_workflow, stream_buffer_metadata | owner_metric_log | guardrail-only |
...
| 2 | PASS | preserve | 2026년 5월 Android 보안 게시판 발행: HAL 취약점 점검 필수 | android_platform_camera_adjacent | 3 | true | false | false | false | true | bound | shortlist_selected | merged | none | android_platform_camera_adjacent counts toward primary_camera_stack_count. | none | none | field-hygiene: background and what_changed overlap, but token count is below hard-fail threshold. |
...
- 2 pt [field-hygiene] 2026년 5월 Android 보안 게시판 발행: HAL 취약점 점검 필수: background and what_changed overlap, but token count is below hard-fail threshold.
