...
| Source discovery 중복 또는 무효 | `duplicate_or_noop_source_discovery` | true | Gemini discovery produced 1 candidate(s) but gemini_new_unique_url_count=0. |

## 소스별 진단

| 소스 | 원본 후보 | 최종 후보 | 주요 차단 원인 | 권장 조치 |
| --- | --- | --- | --- | --- |
| Android Developers Blog | 27 | 3 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
| Android Security Bulletin | 3 | 0 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.; main_eligible=false | 소스 유지, 파서 수정 |
...
| Source discovery 중복 제거/수리 | `REPAIR_SOURCE_DISCOVERY_DUPLICATES` | 전체 | Gemini discovery produced 1 candidate(s) but gemini_new_unique_url_count=0.; Duplicate discovery signal detected: gemini_manual_duplicate_url_count=1, duplicate_discovery_gap_count=1. | medium |
...
| --- | --- | --- | --- |
| missing_optional_artifact | content/newsroom/2026-06-05/evidence-pack-summary.json not found; partial diagnosis will continue. | content/newsroom/2026-06-05/evidence-pack-summary.json |  |
