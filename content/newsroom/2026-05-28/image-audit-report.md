...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Jetpack Compose와 CameraX가 이끄는 대화면 시대: 모든 창 크기에서 완벽한 카메라 미리보기 구현 | 없음 | 1 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
| 2 | Google AI Studio, 프롬프트만으로 Android 앱 빌드 지원: 네이티브 AI 카메라 앱 프로토타이핑 가속화 | 없음 | 1 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
