...
| watchlist | generic_tech_watchlist | 6 | 44 | 8 | release-note-item | yes | release_note_item | Claude Code Changelog | Claude Code Changelog - 2.1.133 | May 7, 2026 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. | [link](https://code.claude.com/docs/en/changelog) |
...
### 3. What's new in the Jetpack Compose April '26 release
...
### 4. Level up your development with Planning Mode and Next Edit Prediction in Android Studio Panda 4
...
### 5. Camera &nbsp;|&nbsp; Android Open Source Project
...
### 33. Claude Code Changelog - 2.1.133
...
- Source gap risk: yes
- Evidence score: 8
- Version/release: 2.1.133
- API/component: Claude Code / AI coding agent
- Behavior change: ​ 2.1.133 May 7, 2026 Added worktree.baseRef setting ( fresh | head ) to choose whether --worktree , EnterWorktree , and agent-isolation worktrees branch from origin/<default> or local HEAD .
- Cross-check 필요: no
- Selection exclusion reason: Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.
- Verification hint: Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.
- Relevance Score: 44
- 요약: ​ 2.1.133 May 7, 2026 Added worktree.baseRef setting ( fresh | head ) to choose whether --worktree , EnterWorktree , and agent-isolation worktrees branch from origin/ or local HEAD .
