...
| watch | watch | camera_driver_image_pipeline | Re: [PATCH WIP v5 5/9] media: qcom: camss: csiphy-3ph: Add Gen2 v1.1 MIPI CSI-2 C-PHY init | lore.kernel.org linux-media list | 2026-05-31T14:06:38Z | Mailing-list/community lead requires primary confirmation. | [link](https://lore.kernel.org/linux-media/20260531140638.67BE71F00893@smtp.kernel.org/) |
...
| watch | watch | camera_driver_image_pipeline | [PATCH WIP v5 6/9] media: qcom: camss: csiphy-3ph: Update Gen2 v1.1 MIPI CSI-2 C-PHY init | lore.kernel.org linux-media list | 2026-05-31T13:08:13Z | Mailing-list/community lead requires primary confirmation. | [link](https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-6-6be0f62b4d65@ixit.cz/) |
| watch | watch | camera_driver_image_pipeline | [PATCH WIP v5 8/9] media: qcom: camss: Account for C-PHY when calculating link frequency | lore.kernel.org linux-media list | 2026-05-31T13:08:13Z | Mailing-list/community lead requires primary confirmation. | [link](https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-8-6be0f62b4d65@ixit.cz/) |
| watch | watch | camera_driver_image_pipeline | [PATCH WIP v5 7/9] media: qcom: camss: csiphy-3ph: Add Gen2 v1.2.1 MIPI CSI-2 C-PHY init | lore.kernel.org linux-media list | 2026-05-31T13:08:13Z | Mailing-list/community lead requires primary confirmation. | [link](https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-7-6be0f62b4d65@ixit.cz/) |
| watch | watch | camera_driver_image_pipeline | [PATCH WIP v5 5/9] media: qcom: camss: csiphy-3ph: Add Gen2 v1.1 MIPI CSI-2 C-PHY init | lore.kernel.org linux-media list | 2026-05-31T13:08:13Z | Mailing-list/community lead requires primary confirmation. | [link](https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-5-6be0f62b4d65@ixit.cz/) |
...
| reference | reference | generic_tech_watchlist | [PATCH WIP v5 0/9] media: camss: Add support for C-PHY configuration on Qualcomm platforms | lore.kernel.org linux-media list | 2026-05-31T13:08:13Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-0-6be0f62b4d65@ixit.cz/) |
...
| reference | reference | generic_tech_watchlist | Re: [BUG] KASAN: slab-use-after-free in au0828_dvb_register | lore.kernel.org linux-media list | 2026-06-01T01:18:42Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/3e600207-7feb-40b1-90c5-6d1c2893fcb8@kylinos.cn/) |
| reference | reference | generic_tech_watchlist | Re: [PATCH v5 5/5] media: qcom: camss: vfe-340: Support for PIX client | lore.kernel.org linux-media list | 2026-05-31T11:15:49Z | Background reference page; not an article candidate. | [link](https://lore.kernel.org/linux-media/178022614455.4008.17510287169443435896.b4-reply@b4/) |
...
### 24. [PATCH WIP v5 0/9] media: camss: Add support for C-PHY configuration on Qualcomm platforms

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-05-31T13:08:13Z
- Link: https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-0-6be0f62b4d65@ixit.cz/
...
- Reason: Background reference page; not an article candidate.
- 날짜 근거 있음: yes
- 요약: Note: WIP tag added, as not everything from the previous review round has been addressed. # Short summary This patch series extends the Qualcomm CAMSS (Camera Subsystem), including CSID and CSIPHY components, to support C-PHY mode configuration. # Background and motivation Modern smartphone cameras increasingly rely on MIPI C-PHY rather than D-PHY, thanks to its higher data throughput and signal efficiency. As a result, many OEMs adopt C-PHY interfaces for main (rear) cameras on Qualcomm-based d

### 25. Re: [PATCH WIP v5 5/9] media: qcom: camss: csiphy-3ph: Add Gen2 v1.1 MIPI CSI-2 C-PHY init

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-05-31T14:06:38Z
- Link: https://lore.kernel.org/linux-media/20260531140638.67BE71F00893@smtp.kernel.org/
- Section: Linux Camera / Driver
- Selection: watch
- Evidence level: watch
...
- 날짜 근거 있음: yes
- 요약: Thank you for your contribution! Sashiko AI review found 1 potential issue(s) to consider: - [High] Uninitialized pointer read when validating C-PHY lane configuration for Gen1 hardware. -- commit 2b99c545d00ed7e65be8ffeddf052d1789d06fa7 Author: Casey Connolly media: qcom: camss: csiphy-3ph: Add Gen2 v1.1 MIPI CSI-2 C-PHY init Add a PHY configuration sequence for the sdm845 which uses a Qualcomm Gen 2 version 1.1 CSI-2 PHY. The PHY can be configured as two phase or three phase in C-PHY or D-PHY
...
### 28. [PATCH WIP v5 6/9] media: qcom: camss: csiphy-3ph: Update Gen2 v1.1 MIPI CSI-2 C-PHY init

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-05-31T13:08:13Z
- Link: https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-6-6be0f62b4d65@ixit.cz/
- Section: Linux Camera / Driver
- Selection: watch
- Evidence level: watch
- Topic: camera_driver_image_pipeline
- Reason: Mailing-list/community lead requires primary confirmation.
- 날짜 근거 있음: yes
- 요약: From: David Heidelberg These values should improve C-PHY behaviour. Should match most recent Qualcomm code. Acked-by: Cory Keitz Suggested-by: Konrad Dybcio Signed-off-by: David Heidelberg --- .../media/platform/qcom/camss/camss-csiphy-3ph-1-0.c \| 18 +++++++++--------- 1 file changed , 9 insertions(+), 9 deletions(-) diff --git a/drivers/media/platform/qcom/camss/camss-csiphy-3ph-1-0.c b/drivers/media/platform/qcom/camss/camss-csiphy-3ph-1-0.c index d837fcf7cd2f0..9a0f009c033bb 100644 --- a/driv

### 29. [PATCH WIP v5 8/9] media: qcom: camss: Account for C-PHY when calculating link frequency

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-05-31T13:08:13Z
- Link: https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-8-6be0f62b4d65@ixit.cz/
- Section: Linux Camera / Driver
- Selection: watch
- Evidence level: watch
- Topic: camera_driver_image_pipeline
- Reason: Mailing-list/community lead requires primary confirmation.
- 날짜 근거 있음: yes
- 요약: From: David Heidelberg Ensure that the link frequency divider correctly accounts for C-PHY operation. The divider differs between D-PHY and C-PHY, as described in the MIPI CSI-2 specification. For more details, see: https://docs.kernel.org/driver-api/media/tx-rx.html#pixel-rate Suggested-by: Sakari Ailus Acked-by: Cory Keitz Tested-by: Cory Keitz Reviewed-by: Bryan O'Donoghue Signed-off-by: David Heidelberg --- drivers/media/platform/qcom/camss/camss-csid.c \| 7 +++++-- drivers/media/platform/qco

### 30. [PATCH WIP v5 7/9] media: qcom: camss: csiphy-3ph: Add Gen2 v1.2.1 MIPI CSI-2 C-PHY init

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-05-31T13:08:13Z
- Link: https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-7-6be0f62b4d65@ixit.cz/
- Section: Linux Camera / Driver
- Selection: watch
- Evidence level: watch
- Topic: camera_driver_image_pipeline
- Reason: Mailing-list/community lead requires primary confirmation.
- 날짜 근거 있음: yes
- 요약: From: Luca Weiss Add a PHY configuration sequence for the sm8250 which uses a Qualcomm Gen 2 version 1.2.1 CSI-2 PHY. The PHY can be configured as two phase or three phase in C-PHY or D-PHY mode. This configuration supports three-phase C-PHY mode. Signed-off-by: Luca Weiss Reviewed-by: Konrad Dybcio Reviewed-by: Bryan O'Donoghue Acked-by: Cory Keitz Signed-off-by: David Heidelberg --- .../platform/qcom/camss/camss-csiphy-3ph-1-0.c \| 111 ++++++++++++++++++++- 1 file changed , 109 insertions(+), 2

### 31. [PATCH WIP v5 5/9] media: qcom: camss: csiphy-3ph: Add Gen2 v1.1 MIPI CSI-2 C-PHY init

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-05-31T13:08:13Z
- Link: https://lore.kernel.org/linux-media/20260531-qcom-cphy-v5-5-6be0f62b4d65@ixit.cz/
- Section: Linux Camera / Driver
- Selection: watch
- Evidence level: watch
- Topic: camera_driver_image_pipeline
- Reason: Mailing-list/community lead requires primary confirmation.
- 날짜 근거 있음: yes
- 요약: From: Casey Connolly Add a PHY configuration sequence for the sdm845 which uses a Qualcomm Gen 2 version 1.1 CSI-2 PHY. The PHY can be configured as two phase or three phase in C-PHY or D-PHY mode. This configuration supports three-phase C-PHY mode. Signed-off-by: Casey Connolly Acked-by: Cory Keitz Reviewed-by: Vladimir Zapolskiy Reviewed-by: Bryan O'Donoghue Co-developed-by: David Heidelberg Signed-off-by: David Heidelberg --- .../platform/qcom/camss/camss-csiphy-3ph-1-0.c \| 70 +++++++++++++++

### 32. Re: [BUG] KASAN: slab-use-after-free in au0828_dvb_register

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-06-01T01:18:42Z
- Link: https://lore.kernel.org/linux-media/3e600207-7feb-40b1-90c5-6d1c2893fcb8@kylinos.cn/
- Section: Linux Camera / Driver
- Selection: reference
- Evidence level: reference
- Topic: generic_tech_watchlist
- Reason: Background reference page; not an article candidate.
- 날짜 근거 있음: yes
- 요약: 在 2026/5/30 03:22, Shuangpeng 写道: > >> On May 29, 2026, at 04:30, xiaopeitux@foxmail.com wrote: >> >> From: Pei Xiao >> >>> Hi Kernel Maintainers, >>> >>> We hit the following KASAN report while testing current upstream kernel: >>> >>> KASAN: slab-use-after-free in au0828_dvb_register >>> >>> on commit: e8c2f9fdadee7cbc75134dc463c1e0d856d6e5c7 (May 25 2026) >>> >>> The reproducer and .config files are here. >>> https://gist.github.com/shuangpengbai/c31163f8ef234ba4fe85038c2f97f9cc >>> >>> I’m ha

### 33. Re: [PATCH v5 5/5] media: qcom: camss: vfe-340: Support for PIX client

- 출처: lore.kernel.org linux-media list
- 출처 URL: https://lore.kernel.org/linux-media/
- 발행일: 2026-05-31T11:15:49Z
- Link: https://lore.kernel.org/linux-media/178022614455.4008.17510287169443435896.b4-reply@b4/
- Section: Linux Camera / Driver
- Selection: reference
- Evidence level: reference
- Topic: generic_tech_watchlist
