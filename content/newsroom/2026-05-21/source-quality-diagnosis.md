...
| --- | --- | --- | --- | --- |
| Android Developers Blog | 24 | 2 | main_eligible=false; reference_only=true | 소스 유지, 파서 수정 |
| ISO C++ Blog | 6 | 2 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
...
| Source discovery 중복 제거/수리 | `REPAIR_SOURCE_DISCOVERY_DUPLICATES` | 전체 | Gemini discovery produced 3 candidate(s) but gemini_new_unique_url_count=0.; Gemini discovery produced no new publishable candidates.; Duplicate discovery signal detected: gemini_manual_duplicate_url_count=3, duplicate_discovery_gap_count=0. | medium |
