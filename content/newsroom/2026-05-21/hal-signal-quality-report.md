...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Jetpack Compose 적응형 UI의 핵심 요소로 부상한 CameraX, 다양한 화면 크기에서의 스트림 설정 안정성 요구 | strong_signal | measurable_test | measurable_test | framework_hal_contract, camerax_app_compatibility | yes | none |
