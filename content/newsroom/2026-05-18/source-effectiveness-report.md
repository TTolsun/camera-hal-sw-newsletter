...
- Recommendations: NO_RECENT_SIGNAL: 39, KEEP: 1, KEEP_AND_FIX_PARSER: 6, KEEP_AND_MONITOR: 1
...
| Metric | Key | Count |
| --- | --- | --- |
| source_url_quality | engineering_blog_with_camera_evidence | 20 |
...
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 31 | 20 | 2 | 2 | 2 |

## Sources Needing Parser Repair

| Source | Recommendation | Collected | Eligible | Source Gap | Top Reason |
| --- | --- | --- | --- | --- | --- |
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 20 | 2 | 18 | main_eligible=false |
...
| android-developers-blog | KEEP_AND_FIX_PARSER | 11 | 0 | 11 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material. |
...
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 31 | 20 | 0.1 | 1 | 1 | 0.9 | 0.75 | 0 |
| android-compatibility-definition-document | KEEP_AND_FIX_PARSER | 0 | 1 | 0 | 0 | 0 | 1 | 1 | 0 |
| android-developers-blog | KEEP_AND_FIX_PARSER | 0 | 11 | 0 | 0 | 0 | 1 | 1 | 0 |
...
- Missing optional artifact content/newsroom/2026-05-18/reporter-candidates.json; related metrics remain zero or artifact-limited.
