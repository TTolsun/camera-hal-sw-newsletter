...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Google I/O 2026: Jetpack Compose와 CameraX를 활용한 대화면 및 폴더블 기기 카메라 미리보기 최적화 | 없음 | 1 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
| 2 | Google AI Studio: 프롬프트 입력을 통한 네이티브 Android 앱 신속 빌드 지원 | 없음 | 1 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
