...
- 주요 진단: 파서 추출 실패, Fallback 기사만 남음
...
| --- | --- | --- | --- | --- |
| Android Developers Blog | 20 | 2 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
| ISO C++ Blog | 15 | 0 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
...
| Media3 Release Notes | 1 | 0 | Generic technology item without article-level camera, driver, SoC, or native tooling evidence; keep as watchlist/briefing material.; finalSelectionEligibility=exclude | 소스 유지, 파서 수정 |
...
| 기사 부족 주간으로 판단, 조치 없음 | `NO_ACTION_THIN_WEEK` | Android Developers Latest Updates | No recent candidates were collected for this source. | medium |
...
| --- | --- | --- | --- |
| missing_optional_artifact | content/newsroom/2026-05-29/source-quality-report.json not found; partial diagnosis will continue. | content/newsroom/2026-05-29/source-quality-report.json |  |
| missing_optional_artifact | content/newsroom/2026-05-29/source-discovery-feedback-report.json not found; partial diagnosis will continue. | content/newsroom/2026-05-29/source-discovery-feedback-report.json |  |
| missing_optional_artifact | content/collected-news/2026-05-29/merged-candidate-manifest.json not found; partial diagnosis will continue. | content/collected-news/2026-05-29/merged-candidate-manifest.json |  |
