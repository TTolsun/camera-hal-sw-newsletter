...
- Recommendations: NO_RECENT_SIGNAL: 29, KEEP_AND_FIX_PARSER: 16, REVIEW_SOURCE_OR_PARSER: 1, KEEP_AND_MONITOR: 1
- Selected main source quality coverage: 2/2
- Main-eligible source quality coverage: 1/1
- Conditional source promoted/blocked: 2/19
...
| source_url_quality | tech_media_lead_requires_cross_check | 2 |
...
| blocker | cross_check_required_but_missing | 2 |
...
| --- | --- | --- | --- | --- | --- | --- |
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 37.15 | 14 | 2 | 2 | 2 |
...
| iso-cpp-blog | KEEP_AND_FIX_PARSER | 37.15 | 14 | 0.1429 | 1 | 1 | 0.8571 | 0.5714 | 0 |
...
| phoronix-linux-camera-media | REVIEW_SOURCE_OR_PARSER | 0 | 2 | 0 | 0 | 0 | 1 | 1 | 0 |
