# Candidate Selection Diagnostics - 2026-06-07
...
- final_selection_blocked=true (25)
- main_eligible=false (24)
- source_gap_risk=true (24)
- reference_only=true (17)
- selection_window=reference_not_main (17)

Homepage Headline:
- decision: latest_camera_hal_article
- current_headline_key: url:https://developer.android.com/jetpack/androidx/releases/camera#1.6.0
- replacement_headline_key: url:https://lore.kernel.org/linux-media/20260606-submit-media-mt9m113-v6-0-8f6d0f79f4d1@herrie.org
