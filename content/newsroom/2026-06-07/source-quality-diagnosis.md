...
| Source discovery 중복 또는 무효 | `duplicate_or_noop_source_discovery` | true | Gemini discovery produced 8 candidate(s) but gemini_new_unique_url_count=0. |
...
| Multimedia bucket 추가 | `ADD_MULTIMEDIA_BUCKET` | 전체 | 8 camera-relevant candidate(s) were not mapped to a known camera bucket. | medium |

## 경고

| 유형 | 메시지 | Source artifact | 심각도 |
| --- | --- | --- | --- |
| missing_optional_artifact | content/newsroom/2026-06-07/evidence-pack-summary.json not found; partial diagnosis will continue. | content/newsroom/2026-06-07/evidence-pack-summary.json |  |
