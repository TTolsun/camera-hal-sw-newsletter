...
| main | android_platform_camera_adjacent | - | 85 | 8 | source-change-event | yes | source_change_event | androidx-camerax-release-notes | CameraX \| Jetpack \| Android Developers | 검토 필요 | Source snapshot event has strong date evidence and source binding. | [link](https://developer.android.com/jetpack/androidx/releases/camera) |
...
### 2. CameraX | Jetpack | Android Developers
...
- Source gap risk: no
- Evidence score: 8
- Version/release: 1.0.0-alpha12
- API/component: Camera source snapshot change
- Behavior change: Release row content changed.
- Cross-check 필요: no
- Selection exclusion reason: Source snapshot event has strong date evidence and source binding.
- Verification hint: Review source-change-events artifacts before using this candidate.
- Relevance Score: 85
- 요약: release_row_changed: Release row content changed.
...
### 30. C++26: A User-Friendly assert() macro -- Sandor Dargo
...
### 35. CppCon 2025 How To Build Robust C++ Inter-Process Queues -- Jody Hagins
...
### 36. JSON and C++26 compile-time reflection: a talk -- Daniel Lemire
...
### 37. What Happens When a Destructor Throws -- Sandor Dargo
...
### 38. CppCon 2025 Crafting the Code You Don’t Write: Sculpting Software in an AI World -- Daisy Hollman
...
### 39. Evolving a Translation System with Reflection in C++
...
### 40. CppCon 2025 Reflection: C++’s Decade-Defining Rocket Engine -- Herb Sutter
