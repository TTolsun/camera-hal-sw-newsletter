...
| --- | --- | --- | --- | --- |
| Android Developers Blog | 21 | 2 | main_eligible=false; reference_only=true | 소스 유지, 파서 수정 |
| ISO C++ Blog | 12 | 0 | main_eligible=false; source_gap_risk=true | 소스 유지, 파서 수정 |
...
| Source discovery 중복 제거/수리 | `REPAIR_SOURCE_DISCOVERY_DUPLICATES` | 전체 | Gemini discovery produced 7 candidate(s) but gemini_new_unique_url_count=0.; Gemini discovery produced no new publishable candidates.; Duplicate discovery signal detected: gemini_manual_duplicate_url_count=7, duplicate_discovery_gap_count=0. | medium |
...
| 기사 부족 주간으로 판단, 조치 없음 | `NO_ACTION_THIN_WEEK` | Android Security Bulletin | No recent candidates were collected for this source. | medium |
