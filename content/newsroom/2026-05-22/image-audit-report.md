...
- 출처 근거 부족 대표 이미지 수 (`selected_image_without_valid_candidate_count`): 1
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | Google I/O 2026: Jetpack Compose 멀티 디바이스 전환에 따른 CameraX 미리보기 호환성 검증 | 있음, 출처 근거 재검토 필요 | 1 | 0 | 추출 출처 정보 부족 (missing_extraction_source) |
